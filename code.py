...
print("Multinomial NB Accuracy Score: ", nb_accuracy)

lsvm = LinearSVC(random_state = 0)
lsvm.fit(X_train, y_train)
y_pred = lsvm.predict(X_val)
lsvm_accuracy = accuracy_score(y_val, y_pred)
print("Logistic Regression Accuracy Score: ", lsvm_accuracy)
...
print("Log reg Accuracy Score: ", log_accuracy_2)

y_pred = nb.predict(X_test)
nb_accuracy_2 = accuracy_score(y_test, y_pred)
print("Multinomial NB Accuracy Score: ", nb_accuracy_2)

y_pred = lsvm.predict(X_test)
lsvm_accuracy_2 = accuracy_score(y_test, y_pred)
print("LSVM Accuracy Score: ", lsvm_accuracy_2)
...
print("Optimum Number of Topics: ", opt_topic)
